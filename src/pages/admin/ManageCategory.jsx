      ...
      <div className="flex flex-col md:flex-row items-center gap-4 py-4">
        <div className="relative w-full md:max-w-sm">
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-search h-4 w-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground"
          >
              ...
              <table className="min-w-full bg-white">
                <thead>
                  <tr className="border-b border-gray-200 text-left">
                    ...
                    <th className="px-6 py-3 text-sm font-medium text-gray-700 uppercase tracking-wider text-right">
                      Actions
                    </th>
                  </tr>
                </thead>
